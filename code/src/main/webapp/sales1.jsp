...
<div class="floating-box"><a href="sales1.jsp" ><img src="https://thumbs.dreamstime.com/b/icon-analysis-business-data-vector-chart-graph-set-finance-symbol-information-design-illustration-concept-marketing-diagram-growth-140837232.jpg" width="100" height="100"></a></div>
...
statement=connection.createStatement();
  sql ="select * from OrderDetails where orderstatus='" + del + "'";
